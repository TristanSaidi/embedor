...
def chimp(n_points):
    save_path = f'{REPO_ROOT}/outputs/chimp'
    ...
    umap_orcmanl_path = os.path.join(chimp_path, 'umap_orcmanl')
    os.makedirs(umap_orcmanl_path, exist_ok=False)
    plt.figure(figsize=(10, 10))
    plot_graph_2D(umap_orcmanl_emb, embedor.G, node_color=labels[embedor.G.nodes()], edge_width=0, node_size=0.1, edge_color='red')
    ...
    tsne_orcmanl_path = os.path.join(chimp_path, 'tsne_orcmanl')
    os.makedirs(tsne_orcmanl_path, exist_ok=False)
    plt.figure(figsize=(10, 10))
    plot_graph_2D(tsne_orcmanl_emb, embedor.G, node_color=labels[embedor.G.nodes()], edge_width=0, node_size=0.1, edge_color='red')
