...
def umap_tsne_param_abl(n_points, dataset):
    ...
    save_path = os.path.join(REPO_ROOT, 'outputs', 'real_data_umap_tsne_param_ablation')
...
if __name__ == "__main__":
    ...
    parser.add_argument("--n_points", type=int, default=25000, help="Number of points to generate.")
