...
#         # total forces
#         update = attraction + repulsion + 0*gravities

#         # print forces
#         print("Attraction", np.linalg.norm(attraction))
#         # print("Repulsion", np.linalg.norm(repulsion))
#         # print("Gravity", np.linalg.norm(gravities))
...
#         energy = abs((update * factor[:, None]).sum())
#         print(f"Iteration: {it}, Energy: {energy}\n")
#         if energy < 1e-10:
#             break
